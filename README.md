...
# PERIODEE – Android Period Application
...
- **Business Logic:** Dedicated engines
    - PhaseInfoEngine
    - TipsEngine
- **Data Layer:**
...
## Data Management
- **Local storage:**  
  DataStore is used to store user preferences and ensure offline availability.
- **Cloud storage:**  
  Firebase Firestore stores cycle history data.
...
## Testing
- **Unit tests:**  
  Business logic tested (cycle phase calculation).
- **Instrumentation tests:**  
  Local DataStore persistence tested on device/emulator.
